...
export default function ProductView({ className, reportHandler, product}) {
  ...
  function GetCategory(subCategoryId){
    if(subCategoryId=="1") return "Dogs"
  }

  function GetBreed(breedId){
    if(breedId==1) return "Pitbull"
  }
    ...
    >
          ...
          <div className="flex gap-2 flex-wrap">
            {product?.images &&
              ...
              product?.images.map((img) => (
                <div
                  onClick={() => changeImgHandler(img.publicId)}
                  key={img.id}
      ...
      <div className="flex-1">
        <div className="product-details w-full mt-10 lg:mt-0">
          ...
          >
            {/* {GetCategory(product.category)} | { GetBreed(product.breed)} */}
            {product?.breeder?.firstname}
          </span>
          <p
            data-aos="fade-up"
          ...
          <div data-aos="fade-up" className="flex space-x-2 items-center mb-7">
            ...
            <span className="text-2xl font-500 text-qred">R{product?.price}.00</span>
          </div>
          ...
          <div data-aos="fade-up" className="product-size mb-[30px]">
            ...
            <div className="w-full">
               ...
               <div className=" h-[50px] flex justify-between items-center px-6 cursor-pointer">
                {/* <Selectbox
                  className="w-full"
                ...
                <p>Color / Markings:</p>
                <p><span>{product?.colorMarkings}</span></p>
              </div>
              <div className=" h-[50px] flex justify-between items-center px-6 cursor-pointer">
               
               <p>Sex:</p>
               <p><span>{product?.sex}</span></p>
             </div>
             <div className="  h-[50px] flex justify-between items-center px-6 cursor-pointer">
               
               <p>Breed:</p>
               <p><span>{product?.breed}</span></p>
             </div>
              <div className=" h-[50px] flex justify-between items-center px-6 cursor-pointer">
               
                <p>Location:</p>
                <p><span>{product?.location}</span></p>
              </div>
              <div className=" h-[50px] flex justify-between items-center px-6 cursor-pointer">
               
               <p>Health Records:</p>
               <p><span>{product?.healthRecords}</span></p>
             </div>
            </div>
          </div>
