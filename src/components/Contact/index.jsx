...
import ContactUs from "../Auth/Profile/tabs/ContactUs";
    ...
    <>
                ...
                <div className="flex space-x-5">
                  ...
                  <div>
                    ...
                    <p className="text-[15px] text-qblack leading-[30px]">
                      WeWork - Coworking & Office Space <br />
                      Sandton
                    </p>
                  </div>
                </div>
            ...
            <div className="">
              ...
              {/* <div className="inputs mt-5">
                ...
                <div>
                  <a href="#">
                    <div className="black-btn text-sm font-semibold w-full h-[50px] flex justify-center items-center buttonSave">
                      <span style={{padding:"12px"}}>Send Now</span>
                    </div>
                  </a>
                </div>
              </div> */}
