                      ...
                      <div className="sherah-psidebar sherah-default-bg">
                        ...
                        <div className="list-group sherah-psidebar__list" id="list-tab" role="tablist">
                          <a className="list-group-item active" data-bs-toggle="list" href="#id1" role="tab"><span className="sherah-psidebar__icon"><svg xmlns="http://www.w3.org/2000/svg" width="15.137" height="18.151" viewBox="0 0 15.137 18.151">
                            ...
                            </span><span className="sherah-psidebar__title">Personal Info</span></a>
                          <a className="list-group-item" data-bs-toggle="list" href="#id2" role="tab"><span className="sherah-psidebar__icon"><svg xmlns="http://www.w3.org/2000/svg" width="17.997" height="18.151" viewBox="0 0 17.997 18.151">
                            ...
                            </span><span className="sherah-psidebar__title">Payment Method</span></a>
                          <a className="list-group-item" data-bs-toggle="list" href="#id3" role="tab"><span className="sherah-psidebar__icon"><svg xmlns="http://www.w3.org/2000/svg" width="14.234" height={18} viewBox="0 0 14.234 18">
                            ...
                            </span><span className="sherah-psidebar__title">Notification Setting</span></a>
                          <a className="list-group-item" data-bs-toggle="list" href="#id4" role="tab"><span className="sherah-psidebar__icon"><svg xmlns="http://www.w3.org/2000/svg" width="18.329" height="17.617" viewBox="0 0 18.329 17.617">
                            ...
                            </span><span className="sherah-psidebar__title">Login Activity</span></a>
                          <a className="list-group-item" data-bs-toggle="list" href="#id5" role="tab"><span className="sherah-psidebar__icon"><svg xmlns="http://www.w3.org/2000/svg" width="13.498" height="17.259" viewBox="0 0 13.498 17.259">
                            ...
                            </span><span className="sherah-psidebar__title">Change Password </span></a>
                          <a className="list-group-item" data-bs-toggle="list" href="#id6" role="tab"><span className="sherah-psidebar__icon"><svg xmlns="http://www.w3.org/2000/svg" width="14.217" height="14.272" viewBox="0 0 14.217 14.272">
                            ...
                            </span><span className="sherah-psidebar__title">Connect With Social </span></a>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="sherah-ptabs__inner">
                          <div className="tab-content" id="nav-tabContent">
                                        ...
                                        <div className="sherah__item-group sherah-default-bg sherah-border">
                                          ...
                                          <div className="sherah-profile-cover sherah-offset-bg sherah-dflex">
                                            ...
                                            <div className="sherah-profile-cover__content">
                                              <h3 className="sherah-profile-cover__title">Dolores Manlin</h3>
                                              <span className="sherah-profile-cover__text sherah-color1">I am Professional Graphic Designer</span>
                                              <ul className="sherah-social mg-top-30">
                                                <li><a href="#" className="sherah-pcolor sherah-border sherah-default-bg"><i className="fa-brands fa-facebook-f" /></a></li>
                                                <li><a href="#" className="sherah-pcolor sherah-border sherah-default-bg"><i className="fa-brands fa-twitter" /></a></li>
                                                <li><a href="#" className="sherah-pcolor sherah-border sherah-default-bg"><i className="fa-brands fa-linkedin" /></a></li>
                                                <li><a href="#" className="sherah-pcolor sherah-border sherah-default-bg"><svg xmlns="http://www.w3.org/2000/svg" width={13} height={13} viewBox="0 0 13 13">
                                          ...
                                          <div className="sherah-profile-info__v2 mg-top-30">
                                            ...
                                            <ul className="sherah-profile-info__list sherah-dflex-column">
                                              <li className="sherah-dflex">
                                                <h4 className="sherah-profile-info__title">Full Name :</h4>
                                                <p className="sherah-profile-info__text">Jangoch Ankon</p>
                                              </li>
                                              <li className="sherah-dflex">
                                                <h4 className="sherah-profile-info__title">About  :</h4>
                                                <p className="sherah-profile-info__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur sodales sits a amet nunc et vehicula. Mauris sed lectus nisi. Suspendisse velit mi, pretiums as non euismod vitae Suspendisse velit mi, pretium non euismod vitae</p>
                                              </li>
                                              <li className="sherah-dflex">
                                                <h4 className="sherah-profile-info__title">Email :</h4>
                                                <p className="sherah-profile-info__text">infoyoursiddik@gmail.com</p>
                                              </li>
                                              <li className="sherah-dflex">
                                                <h4 className="sherah-profile-info__title">Phone :</h4>
                                                <p className="sherah-profile-info__text">+8801408317199</p>
                                              </li>
                                              <li className="sherah-dflex">
                                                <h4 className="sherah-profile-info__title">Full Name :</h4>
                                                <p className="sherah-profile-info__text">Jangoch Ankon</p>
                                              ...
                                              <li className="sherah-dflex">
                                                <h4 className="sherah-profile-info__title">Date of Birth :</h4>
                                                <p className="sherah-profile-info__text">02/02/1997</p>
                                              </li>
                                              <li className="sherah-dflex">
                                                <h4 className="sherah-profile-info__title">Address :</h4>
                                                <p className="sherah-profile-info__text">3801 Chalk Butte Rd, Cut Bank, MT 59427, United States</p>
                                              </li>
                                              <li className="sherah-dflex">
                                                <h4 className="sherah-profile-info__title">Country :</h4>
                                                <p className="sherah-profile-info__text">United States</p>
                                              </li>
                                              <li className="sherah-dflex">
                                                <h4 className="sherah-profile-info__title">Language :</h4>
                              ...
                              <form action="#">
                                <div className="sherah-paymentm sherah__item-group sherah-default-bg sherah-border">
                                  ...
                                  <div className="sherah__item-button--group mg-btm-20">
                                    ...
                                    <button className="sherah-btn sherah-btn__secondary">Add New Card</button>
                                  </div>
                                  {/* End Payment Button */}
                                  <h4 className="sherah-default-bg sherah-border__title">Add a payment method</h4>
                                  <ul className="sherah-paymentm__list">
                                    <li className="sherah-paymentm__single">
                                      <div className="sherah-paymentm__name">
                                        ...
                                        <div className="sherah-paymentm__content">
                                          <h4 className="sherah-paymentm__title sherah-pcolor">Bank of America																						</h4>
                                          <p className="sherah-paymentm__text">Bank<span>**************</span>5421</p>																					<p />
                                          <span className="sherah-paymentm__badge sherah-color3">Verified</span>
                                        </div>
                                      </div>
                                      <div className="sherah-paymentm__manage-btn">
                                        <button className="sherah-btn sherah-btn__fourth">Manage</button>
                                      </div>
                                    </li>	
                                    <li className="sherah-paymentm__single">
                                      <div className="sherah-paymentm__name">
                                        ...
                                        <div className="sherah-paymentm__content">
                                          <h4 className="sherah-paymentm__title sherah-pcolor">Master Card</h4>
                                    ...
                                    <li className="sherah-paymentm__single">
                                      <div className="sherah-paymentm__name">
                                        ...
                                        <div className="sherah-paymentm__content">
                                          <h4 className="sherah-paymentm__title sherah-pcolor">Paypal Account</h4>
                                          <p className="sherah-paymentm__text">Bank    **********5535</p>
                                          <span className="sherah-paymentm__badge sherah-color3">Verified</span>
                                        </div>
                                      </div>
                                  ...
                                  <ul className="sherah-paymentm__list sherah-paymentm__list--notify pt-0">
                                    <li className="sherah-paymentm__single sherah-paymentm__single--notify sherah-border">
                                      <div className="sherah-paymentm__name">
                                        ...
                                        <div className="sherah-paymentm__content">
                                          <h4 className="sherah-paymentm__title sherah-paymentm__title--notify">Send Inactive for 7 days</h4>
                                          <p className="sherah-paymentm__text sherah-paymentm__text--notify">Unlockable content, only revealed by the owner of the item.</p>
                                        </div>
                                      </div>
                                    ...
                                    <li className="sherah-paymentm__single sherah-paymentm__single--notify sherah-border">
                                      <div className="sherah-paymentm__name">
                                        ...
                                        <div className="sherah-paymentm__content">
                                          <h4 className="sherah-paymentm__title sherah-paymentm__title--notify">New Contributions</h4>
                                          <p className="sherah-paymentm__text sherah-paymentm__text--notify">Evey new prodcuts upload seccessfullly doen you can get notifcation</p>
                                        </div>
                                      </div>
                                      <div className="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
                                        <label className="sherah__item-switch">
                                    ...
                                    <li className="sherah-paymentm__single sherah-paymentm__single--notify sherah-border">
                                      <div className="sherah-paymentm__name">
                                        ...
                                        <div className="sherah-paymentm__content">
                                          <h4 className="sherah-paymentm__title sherah-paymentm__title--notify">Empty Buffer</h4>
                                          <p className="sherah-paymentm__text sherah-paymentm__text--notify">Every new products sell you can get notification</p>
                                        </div>
                                      </div>
                                      <div className="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
                                        <label className="sherah__item-switch">
                                          ...
                                          <svg xmlns="http://www.w3.org/2000/svg" width="14.358" height="21.675" viewBox="0 0 14.358 21.675">
                                            <g id="Icon" transform="translate(0.378 1.017)">
                                              <g id="Group_53" data-name="Group 53" transform="translate(0)">
                                                <path id="Path_186" data-name="Path 186" d="M32.632,36l-6.8,2.606L19.03,36l6.8,7.85Z" transform="translate(-19.03 -23.956)" fill="none" stroke="#fff" strokeWidth={1} />
                                                <path id="Path_187" data-name="Path 187" d="M32.541,23.349,26.716,13.03,20.89,23.349l5.826,2.234Z" transform="translate(-19.915 -13.03)" fill="none" stroke="#fff" strokeWidth={1} />
                                              </g>
                                            </g>
                                          </svg>
                                        </div>
                                        <div className="sherah-paymentm__content">
                                          <h4 className="sherah-paymentm__title sherah-paymentm__title--notify">Your Ethereum Balance</h4>
                                          <p className="sherah-paymentm__text sherah-paymentm__text--notify">Evey new follower  you can get notifcation</p>
                                        </div>
                                      </div>
                                      <div className="sherah-ptabs__notify-switch  sherah-ptabs__notify-switch--two">
                                        <label className="sherah__item-switch">
                                    ...
                                    <li className="sherah-paymentm__single sherah-paymentm__single--notify sherah-border">
                                      <div className="sherah-paymentm__name">
                                        ...
                                        <div className="sherah-paymentm__content">
                                          <h4 className="sherah-paymentm__title sherah-paymentm__title--notify">New Offer</h4>
                                          <p className="sherah-paymentm__text sherah-paymentm__text--notify">Every new products sell you can get notification</p>
                                        </div>
                                      </div>
                                      <div className="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
                                    ...
                                    <li className="sherah-paymentm__single sherah-paymentm__single--notify sherah-border">
                                      <div className="sherah-paymentm__name">
                                        ...
                                        <div className="sherah-paymentm__content">
                                          <h4 className="sherah-paymentm__title sherah-paymentm__title--notify">You swapped exactly</h4>
                                          <p className="sherah-paymentm__text sherah-paymentm__text--notify">Upload successfully done you can get notification</p>
                                        </div>
                                      </div>
                                      <div className="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
                                        <label className="sherah__item-switch">
                                      ...
                                      <div className="sherah-paymentm__name">
                                        <div className="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--5">
                                          <svg xmlns="http://www.w3.org/2000/svg" width="18.956" height="18.925" viewBox="0 0 18.956 18.925">
                                            <path id="star_1_" data-name="star (1)" d="M16.971,6.241l-5.36-.819L9.21.305a.567.567,0,0,0-.986,0l-2.4,5.117-5.36.819a.545.545,0,0,0-.307.919l3.894,3.991-.92,5.642a.545.545,0,0,0,.8.564l4.787-2.646L13.5,17.358a.545.545,0,0,0,.8-.564l-.92-5.642L17.279,7.16a.545.545,0,0,0-.307-.92Z" transform="translate(0.761 0.732)" fill="none" stroke="#fff" strokeWidth="1.5" />
                                          </svg>
                                        </div>
                                        <div className="sherah-paymentm__content">
                                          <h4 className="sherah-paymentm__title sherah-paymentm__title--notify">A new rating has been received</h4>
                                          <p className="sherah-paymentm__text sherah-paymentm__text--notify">Every new products sell you can get notification</p>
                                        </div>
                                      </div>
                                      <div className="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
                            ...
                            <div className="tab-pane fade" id="id4" role="tabpanel">
                              <form action="#">
                                <div className="sherah-personals__history sherah-paymentm sherah__item-group sherah-default-bg sherah-border">
                                  <table id="sherah-table__main" className="sherah-table__main sherah-table__main--activity">
                                    <thead className="sherah-table__head">
                                      <tr>
                                        <th className="sherah-table__column-1 sherah-table__h1">Name</th>
                                        <th className="sherah-table__column-2 sherah-table__h2">IP</th>
                                        <th className="sherah-table__column-3 sherah-table__h3">Time</th>
                                        <th className="sherah-table__column-4 sherah-table__h4">Action</th>
                                      </tr>
                                    </thead>
                                      ...
                                      <tr>
                                        <td className="sherah-table__column-1 sherah-table__data-1">
                                          <div className="sherah-table__product-content">
                                            <p className="sherah-table__product-desc">Chrome on Window</p>
                                          </div>
                                        </td>
                                        <td className="sherah-table__column-2 sherah-table__data-2">
                                          <div className="sherah-table__product-content">
                                            <p className="sherah-table__product-desc">278.281.987.111</p>
                                          </div>
                                        </td>
                            ...
                            <div className="tab-pane fade" id="id5" role="tabpanel">
                              <div className="sherah-paymentm sherah__item-group sherah-default-bg sherah-border ">
                                <h4 className="sherah__item-group sherah-default-bg sherah-border__title">Change Password</h4>
                                <div className="row">
                                  <div className="col-xxl-8  col-lg-6 col-md-6 col-12">
                                    ...
                                    <form className="sherah-wc__form-main sherah-form-main--v2 p-0" action="#" method="post">
                                      <div className="form-group">
                                        <label className="sherah-wc__form-label">Old Password *</label>
                                        <div className="form-group__input">
                                          <input className="sherah-wc__form-input" placeholder="●●●●●●" id="password-field" type="password" name="password" maxLength={8} required="required" />
                                        </div>
                                      </div>
                                      <div className="form-group">
                                      ...
                                      <div className="form-group">
                                        <label className="sherah-wc__form-label">Re-enter Password *</label>
                                        <div className="form-group__input">
                                          <input className="sherah-wc__form-input" placeholder="●●●●●●" id="password-field" type="password" name="password" maxLength={8} required="required" />
                                        </div>
                                      </div>
                                      <div className="form-group mg-top-30">
                                        <button type="submit" className="sherah-btn sherah-btn__primary">Changed Password</button>
                                      </div>
                                    </form>	
                                    {/* End Sign in Form */}
                                  </div>
                            ...
                            <div className="tab-pane fade" id="id6" role="tabpanel">
                              <div className="sherah-accordion accordion accordion-flush sherah__item-group sherah-default-bg sherah-border" id="sherah-accordion">
                                <div className="sherah__item-group sherah-default-bg sherah-border mg-top-30">
                                  <h4 className="sherah-default-bg sherah-border__title">Social Account</h4>
                                  <div className="sherah__item-form--group">
                                    <form className="sherah-wc__form-main p-0">
                                      <div className="row">
                                        <div className="col-lg-6 col-12">
                                          <div className="sherah__item-form--group mg-top-form-20">
                                            <label className="sherah-wc__form-label">Facebook *</label>
                                            <div className="sherah-input-icon">
                                              <input className="sherah-wc__form-input" type="url" placeholder="Facebook profile link" />
                                              <div className="sherah-form-icon sherah-color1"><i className="fa-brands fa-facebook-f" /></div>
                                            </div>
                                          </div>
                                        </div>	
                                        <div className="col-lg-6 col-12">
                                          <div className="sherah__item-form--group mg-top-form-20">
                                            <label className="sherah-wc__form-label">Instagram *</label>
                                            <div className="sherah-input-icon">
                                              <input className="sherah-wc__form-input" type="url" placeholder="Instagram profile link" />
                                              <div className="sherah-form-icon sherah-color1"><i className="fa-brands fa-instagram" /></div>
                                            </div>
                                          </div>
                                        </div>	
                                        <div className="col-lg-6 col-12">
                                          <div className="sherah__item-form--group mg-top-form-20">
                                            ...
                                            <div className="sherah-input-icon">
                                              <input className="sherah-wc__form-input" type="url" placeholder="Twitter profile link" />
                                              <div className="sherah-form-icon sherah-color1"><i className="fa-brands fa-twitter" /></div>
                                            </div>
                                          </div>
                                        </div>	
                                        <div className="col-lg-6 col-12">
                                          <div className="sherah__item-form--group  mg-top-form-20">
                                            <label className="sherah-wc__form-label">Google Plus*</label>
                                            <div className="sherah-input-icon">
                                              <input className="sherah-wc__form-input" type="url" placeholder="Google Plus profile link" />
                                              <div className="sherah-form-icon sherah-color1"><i className="fa-brands fa-google-plus" /></div>
                                            </div>
                                          </div>
                                        </div>	
                                        <div className="col-lg-6 col-12">
                                          <div className="sherah__item-form--group  mg-top-form-20">
                                            <label className="sherah-wc__form-label">Pinterest* </label>
                                            <div className="sherah-input-icon">
                                              <input className="sherah-wc__form-input" type="url" placeholder="Pinterest profile Link" />
                                              <div className="sherah-form-icon sherah-color1"><i className="fa-brands fa-pinterest" /></div>
                                            </div>
                                          </div>
                                        </div>	
                                        <div className="col-lg-6 col-12">
                                          <div className="sherah__item-form--group  mg-top-form-20">
                                            <label className="sherah-wc__form-label">Dribbble *</label>
                                            <div className="sherah-input-icon">
                                              <input className="sherah-wc__form-input" type="url" placeholder="Dribbble profile Link" />
                                              <div className="sherah-form-icon sherah-color1"><i className="fa-brands fa-dribbble" /></div>
                                            </div>
                                          </div>
                                        </div>	
                                        <div className="col-lg-6 col-12">
                                          <div className="sherah__item-form--group  mg-top-form-20">
                                            <label className="sherah-wc__form-label">Linkedin *</label>
                                            <div className="sherah-input-icon">
                                              <input className="sherah-wc__form-input" type="url" placeholder="Linkdin profile link" />
                                              <div className="sherah-form-icon sherah-color1"><i className="fa-brands fa-linkedin" /></div>
                                            </div>
                                          </div>
                                        </div>	
                                        <div className="col-lg-6 col-12">
                                          <div className="sherah__item-form--group  mg-top-form-20">
                                            ...
                                            <div className="sherah-input-icon">
                                              <input className="sherah-wc__form-input" type="url" placeholder="Behance profile link" />
                                              <div className="sherah-form-icon sherah-color1"><i className="fa-brands fa-behance" /></div>
                                            </div>
                                          </div>
                                        </div>	
                                      </div>	
                                      <div className="row mg-top-30">
                                        <div className="sherah__item-form--group">
                                          <button type="submit" className="sherah-btn sherah-btn__primary">Save Now</button>
                                        </div>
                                      </div>
                                    </form>	
                                  </div>
                            ...
                            <div className="tab-pane fade" id="id7" role="tabpanel">
                              <div className="sherah-ptabs__page sherah__item-group sherah-default-bg sherah-border">
                                <h4 className="sherah__item-group sherah-default-bg sherah-border__title">Terms and Conditions</h4>
                                ...
                                <h3 className="sherah-ptabs__page-title">4. Purchaser’s obligations</h3>
