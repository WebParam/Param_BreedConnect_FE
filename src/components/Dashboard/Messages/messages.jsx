...
async function payWithPaystack(purchaseRequestId) {
  ...
  const res = await CreatePaymentLink("652c07f7a305326f2ecd899d");
  debugger;

}

async function pay(paymentLinkId){
  const res = await GenerateLink("65187e1fd746faf1160084d8"
                              ...
                              <div className="sherah-chatbox__main-content">
                                <div className="sherah-chatbox__incoming-chat">
                                  <p className="sherah-chatbox__incoming-text">
                                    ...
                                    and change the color themei of the website
                                    to pink. I Can you as please change the
                                    color a theme of the website to pink and
                                    purple?
                                  </p>
                                </div>
                              </div>
                          ...
                          <li>
                            <div className="sherah-chatbox__chat">
                              <div className="sherah-chatbox__main-content">
                                <div className="sherah-chatbox__incoming-chat">
                                  <p className="sherah-chatbox__incoming-text">
                                    Can you please change the color theme the
                                    website.
                                  </p>
                                </div>
                              </div>
                          ...
                          <li>
                            <div className="sherah-chatbox__chat">
                              ...
                              <div className="sherah-chatbox__main-content">
                                <div className="sherah-chatbox__incoming-chat">
                                  <p className="sherah-chatbox__incoming-text">
                                    In computer programming, a comment is a
                          ...
                          <li>
                            <div className="sherah-chatbox__chat">
                              ...
                              <div className="sherah-chatbox__main-content">
                                <div className="sherah-chatbox__incoming-chat">
                                  <p className="sherah-chatbox__incoming-text">
                                    They are added with the purpose of making
                                    the source.
                                  </p>
                                </div>
                              </div>
                          ...
                          <li>
                            <div className="sherah-chatbox__chat">
                              <div className="sherah-chatbox__main-content">
                                <div className="sherah-chatbox__incoming-chat">
                                  <p className="sherah-chatbox__incoming-text">
                                    Mention of something that deserves
                                  </p>
                                  <ul className="sherah-chatbox__imoji">
                                    <li>
                                      <img src="img/imoji.png" alt="#" />
                                    </li>
                                    <li>
                                      <img src="img/imoji.png" alt="#" />
                                    </li>
