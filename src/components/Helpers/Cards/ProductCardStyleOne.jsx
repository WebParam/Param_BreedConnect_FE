    ...
    >
      ...
      <div className="product-card-details px-[30px] pb-[30px] relative">
        ...
        <div className="absolute w-full h-10 px-[30px] left-0 top-40 group-hover:top-[85px] transition-all duration-300 ease-in-out">
         {datas.status == 0 && status==0 ?
          <button type="button" className={type===3?'blue-btn':'yellow-btn'} onClick={()=>requestToPurchase(datas.id)}>
        ...
        :
          <button disabled type="button" className={type===3?'blue-btn':'yellow-btn'}>
            <div className="flex items-center space-x-3">
              <span>
                <svg
                  width="14"
              ...
              <span style={{width: "100%", fontSize: "12px"}}>Request has been sent</span>
            </div>
          </button>
          }
