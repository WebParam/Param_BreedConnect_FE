...
<div className="sherah-body-area">
    ...
    <div className="sherah-smenu">
      ...
      <div className="admin-menu">
        ...
        <a
                // className={currentUrl.includes("breeder-dash")?"":"collapsed"}
                  href="/breeder-dash"
        ...
        <div className="admin-menu__one sherah-sidebar-padding">
          ...
          <div className="menu-bar">
            ...
            <li>
                <a  className={currentUrl.includes("breeder-profile")?"":"collapsed"} href="/breeder-profile">
                  <span className="menu-bar__text">
                    <span className="sherah-menu-icon sherah-svg-icon__v1">
                      <svg
                        className="sherah-svg-icon"
              ...
              <li>
                <a   className={currentUrl.includes("messages-breeder")?"":"collapsed"}  href="/messages-breeder">
                  <span className="menu-bar__text">
                    <span className="sherah-menu-icon sherah-svg-icon__v1">
                      <svg
                        className="sherah-svg-icon"
              ...
              <li>
                <a
                  href="/orders"
                  className={currentUrl.includes("orders")?"":"collapsed"}
                  data-bs-toggle="collapse"
              ...
              <li>
                <a  className={currentUrl.includes("calender")?"":"collapsed"} href="/calender">
                  <span className="menu-bar__text">
                    <span className="sherah-menu-icon sherah-svg-icon__v1">
                      <svg
                        className="sherah-svg-icon"
                    ...
                    <span className="menu-bar__name">Calender</span>
                  </span>
                </a>
              </li>
              <li>
                <a
                  href="/swipes"
                  className={currentUrl.includes("swipes")?"":"collapsed"}
                  data-bs-toggle="collapse"
                  data-bs-target="#menu-item__orders"
                >
                  <span className="menu-bar__text">
                    ...
                    <span className="menu-bar__name">Swipes</span>
                  </span>
                  <span className="sherah__toggle" />
                </a>
              ...
              <li>
                <a
                  ...
                  className={currentUrl.includes("product")?"":"collapsed"}
              ...
              <li>
                ...
                >
                  <span className="menu-bar__text">
                    ...
                    <span className="menu-bar__name">Reviews</span>
                  </span>{" "}
                  <span className="sherah__toggle" />
                </a>
        ...
        <div className="row g-0">
          <div className="col-12">
            ...
            <div className="sherah-header__inner">
              <div className="sherah-header__middle" style={{    paddingLeft: "40%"}}>
                <div className="sherah__sicon close-icon d-xl-none">
                  <svg
                    width={9}
                    height={15}
