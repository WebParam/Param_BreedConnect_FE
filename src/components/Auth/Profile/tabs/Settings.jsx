...
import { getProduct, updateProduct, uploadProduct, getUserProfile } from "../../../../api/endpoints";
  ...
  <div className="row">
    <div className="col-lg-3 col-md-2 col-12 sherah-personals__list mg-top-30">
      <div className="sherah-psidebar sherah-default-bg">
        ...
        >
          <a
            className={`list-group-item ${activeTab === 'id1' ? "active" : ''}`}
            data-toggle="list"
            href="#settings#id1"
            role="tab"
            aria-selected={activeTab === 'id1' ? 'true' : 'false'}
          ...
          >
            ...
            <span className="sherah-psidebar__title">Personal Info</span>
          </a>
          {/* <a
          ...
          >
            ...
            <span className="sherah-psidebar__title">Notification Setting</span>
          </a> */}
          <a
             className={`list-group-item ${activeTab === 'id4' ? "active" : ''}`}
            data-toggle="list"
            href="#settings#id4"
            role="tab"
            aria-selected={activeTab === 'id4' ? 'true' : 'false'}
          ...
          >
            ...
            <span className="sherah-psidebar__title">Connect With Social </span>
          </a> */}
        </div>
      </div>
    </div>
      ...
      <div className="sherah-ptabs">
        <div className="sherah-ptabs__inner">
          <div className="tab-content" id="nav-tabContent">
            {/*  Features Single Tab */}
            <div className={`tab-pane ${activeTab === 'id1' ? 'active' : ''}`}
          id="id1">
            {/* <div className="tab-pane fade active show" id="id1" role="tabpanel"> */}
              <form action="#">
                <div className="row">
                    ...
                    <li className="sherah-paymentm__single sherah-paymentm__single--notify sherah-border">
                      <div className="sherah-paymentm__name">
                        ...
                        <div className="sherah-paymentm__content">
                          ...
                          <p className="sherah-paymentm__text sherah-paymentm__text--notify">
                            Evey new prodcuts upload seccessfullly doen you can
                            get notifcation
                          </p>
                        </div>
                      </div>
            ...
            {/* <div className="tab-pane fade" id="#settings#id4" role="tabpanel"> */}
            <div className={`tab-pane ${activeTab === 'id4' ? 'active' : ''}`}
          id="id4">
              <form action="#">
                <div className="sherah-personals__history sherah-paymentm sherah__item-group sherah-default-bg sherah-border">
                  ...
                  >
                    ...
                    {loginActivities.map((item,index) => { return (
                        <tr key={index}> 
            ...
            <div className={`tab-pane ${activeTab === 'id5' ? 'active' : ''}`} id="id5">
              <div className="sherah-paymentm sherah__item-group sherah-default-bg sherah-border ">
            ...
            <div className="tab-pane fade" id="id7" role="tabpanel">
              <div className="sherah-ptabs__page sherah__item-group sherah-default-bg sherah-border">
                ...
                <p>
                  What you do own when you buy an NFT are the keys to a
                  non-fungible – perhaps unique – token. That token is yours to
                  trade or hold or display in Decentraland. But the digital file
                  associated with an NFT is just as easy to copy and paste and
                  download as any other – the Finally, players lose their NFTs
                  sometimes according to the rules and regulations of the NFT
                  game.
                </p>
                ...
                <p>
                  ...
                  confirm that you have the legal capacity to receive and hold
                  and make use of the NFT under French jurisdiction and any
                  other relevant jurisdiction.Acceptance. By participating in
                  the Sale, You accept and agree to these Terms and Conditions
                  without any condition or restriction.If You do not agree to
                  this Contract, You shall not participate in the Sale made by
                  the Company Exercitation veniam consequat sunt nostrud
                  amet.Capacity. You confirm that you have the legal capacity to
                  receive and hold find to end.Contract, You shall not
                ...
                <blockquote>
                  ...
                  the part that gets the least amount of attention: The
                  underlying data. More than any other aspect, the data will
                  make or break a dashboard.Within this definition, successful
                  administration appears to rest on three basic skills, which we
                  will call technical, and conceptual.
                </blockquote>
                <h3 className="sherah-ptabs__page-title">3. The Sale</h3>
                <p>
                  The Company offers NFTs featuring the Betonyou universe. The
                  holders of one or more NFTs will be able to win cryptos while
                  playing video games. In the future, the Company plans to
                  develop its own games and Metaverse around the Betonyou
                  universe (“Project”).
                </p>
                <p>
                ...
                <p>
                  Company undertakes to act with the care normally expected from
                  a professional in his field and to comply with the best
                  practice in force. The best endeavor obligation only binds the
                  Company.
                </p>
              </div>
            </div>
